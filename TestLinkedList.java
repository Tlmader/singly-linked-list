...
public class TestLinkedList{
	...
	public void testIteratorAdd(){
		// System.out.println("TEST: testIteratorAdd");
    ...
    public void testAdd(){
        ...
        for(int i = 9; i > 0; i--){
			listElement = it.next();
			// System.out.println(i == listElement.intValue());
        	assertEquals(i, listElement.intValue()); 
        }
    }
    ...
    public void testDeleteEvenNumbers(){
		// System.out.println("TEST: testDeleteEvenNumbers");
        // first, remove all the even numbers
        Iterator<Integer> it = list.iterator();
        while(it.hasNext()){
			// System.out.println("testDeleteEvenNumbers: while(it.hasNext())");
            Integer theVal = it.next().intValue();
            if( theVal.intValue() % 2 == 0){
				// System.out.println("testDeleteEvenNumbers: theVal.intValue() % 2 == 0");
                it.remove();
            }
        }
    ...
    public void testEmptyRemove(){
		// System.out.println("TEST: testEmptyRemove");
        list.clear();
    ...
    public void testInvalidNext(){
		// System.out.println("TEST: testInvalidNext");
        list.clear();
    ...
    public void testGetNthToLast(){
		// System.out.println("TEST: testGetNthToLast");
